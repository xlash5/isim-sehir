...
- [ ] Countdown starts when all players ready + min players + categories set
- [ ] Countdown displayed clearly to all players (synced within ~1s)
- [ ] Countdown cancels when any player un-readies, new player joins, or admin edits settings
- [ ] Admin can start immediately without countdown
- [ ] Game auto-starts at 0
